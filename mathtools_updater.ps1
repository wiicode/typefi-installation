...
function updateMathToolsCC($YYYY)
{
    ...
    Remove-Item $idsLocation\Plug-Ins\movemen -Force -Recurse
...
If (Test-Path $idsLocation\Plug-Ins\movemen)
    {
        Write-Host "DEBUG: OK! MathTools was found."
    }

Else
    {
        Write-Host "DEBUG: WARN! MathTools was not found."
