...
$global:mathtools_version = "3_0_1_065" #Example: "3_0_1_055"
$global:mathtools_url = "http://movemen.com/files/downloads/mtv3/065" #do not add trailing slash, example: "http://movemen.com/files/downloads/mtv3/055"
